...
return [
    ...
    'failures' => [
        ...
        'post_restoration_required' => 'It is necessary to restore deleted post first.',
    ...
    'successes' => [
        ...
        'deleted_post_got' => 'Deleted post information was successfully returned.',
        'deleted_post_permanently_cleaned' => 'Deleted post was successfully cleaned permanently.',
        'deleted_post_restored' => 'Deleted post was successfully restored.',
        'deleted_posts_list' => 'Deleted posts list was successfully returned.',
        'empty_comments_list' => 'No comments have been saved. The list is empty.',
        'empty_deleted_comments_list' => 'No comments have been deleted. The list is empty.',
        'empty_deleted_posts_list' => 'No posts have been deleted. The list is empty.',
        'empty_posts_list' => 'No posts have been saved. The list is empty.',
        'post_deleted' => 'Post was deleted successfully.',
        'post_got' => 'Post information was successfully returned.',
        'posts_list' => 'Posts list was successfully returned.',
